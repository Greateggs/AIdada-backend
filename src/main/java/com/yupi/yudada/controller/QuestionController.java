...
public class QuestionController {
    ...
    private String getGenerateQuestionUserMessage(App app, int questionNum, int optionsNum) {
        StringBuilder sb = new StringBuilder();
        sb.append(app.getAppName()).append("\n");
        sb.append(app.getAppDesc()).append("\n");
        sb.append(AppTypeEnum.getEnumByValue(app.getAppType()).getText() + "类").append("\n");
        sb.append(questionNum).append("\n");
        sb.append(optionsNum);
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        String message = getGenerateQuestionUserMessage(app, questionNumber, optionNumber);

        // 封装prompt请求参数
        // AI生成题目
        String result = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, message, null );
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // AI生成题目, SSE流式返回
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, message, null);
        // 左括号计数器
        ...
        modelDataFlowable
                ...
                .map(messages -> messages.replaceAll("\\s",""))
                ...
                .doOnNext( c->{
                    ...
                    if (c == '}') {
                        ...
                        if (counter.get() == 0) {
                            emitter.send(JSONUtil.toJsonStr(sb.toString()));
                            // 清空
                            sb.setLength(0);
                        }
